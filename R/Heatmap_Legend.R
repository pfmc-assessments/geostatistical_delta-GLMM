Heatmap_Legend <-
function( colvec, heatrange, textmargin=NULL, labeltransform="uniform" ){
  par( xaxs="i", yaxs="i", mar=c(1,0,1,2+ifelse(is.null(textmargin),0,1.5)), mgp=c(1.5,0.25,0), tck=-0.02 )
  N = length(colvec)
  ...
  if(!is.null(textmargin)) mtext(side=4, text=textmargin, line=2, cex=1.5)
