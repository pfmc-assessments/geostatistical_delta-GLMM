...
function( n_i, n_x, n_t, n_v, n_j, n_k, n_l, Aniso, FieldConfig, ObsModel, Options=c(0,0), b_i, a_i, v_i, s_i, t_i, a_xl, X_xj, Q_ik, MeshList ){
  ...
  if(Version=="geo_index_v3c"){
    ...
    Return[['spde']] = list("n_s"=MeshList$spde$n.spde, "n_tri"=nrow(MeshList$mesh$graph$tv), "Tri_Area"=MeshList$Tri_Area, "E0"=MeshList$E0, "E1"=MeshList$E1, "E2"=MeshList$E2, "TV"=MeshList$TV-1, "G0"=MeshList$spde$param.inla$M0, "G0_inv"=inla.as.dgTMatrix(diag(1/diag(MeshList$spde$param.inla$M0))) )
  }
  return( Return )
}
