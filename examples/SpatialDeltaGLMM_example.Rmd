...
If you have further questions after reading this tutorial, please explore the [GitHub repo](https://github.com/nwfsc-assess/geostatistical_delta-GLMM/#description) mainpage, wiki, and glossary.  Also please explore the R help files, e.g., `?Data_Fn` for explanation of data inputs, or `?Param_Fn` for explanation of parameters.  
