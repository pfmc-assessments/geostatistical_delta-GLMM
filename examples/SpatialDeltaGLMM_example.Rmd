...
If you have further questions after reading this tutorial, please explore the [GitHub repo](https://github.com/nwfsc-assess/geostatistical_delta-GLMM/#description) mainpage, wiki, and glossary.  Also please explore the R help files, e.g., `?PlotIndex_Fn`.  
...
and also browse the [GitHub list](https://github.com/nwfsc-assess/geostatistical_delta-GLMM/#description-of-package) of packages.
...
```{r explore_data, results="hide", tidy=TRUE, message=FALSE}
