...
# California Current
# Test default + including vessel-year effects (48 sec)
test_that("West Coast groundfish bottom trawl survey, canary rockfish is working ", {
  ...
  TmbList = SpatialDeltaGLMM::Build_TMB_Fn("TmbData"=TmbData, "RunDir"=example_path, "Version"=Version, "RhoConfig"=RhoConfig, "VesselConfig"=VesselConfig, "loc_x"=Spatial_List$loc_x)
