...
context("Testing all examples")

# Use "extdata" in "inst" because its loaded with R packages
example_path <- system.file("extdata", package="SpatialDeltaGLMM")
#Local testing: example_path <- "C:/Users/James.Thorson/Desktop/Project_git/geostatistical_delta-GLMM/inst/extdata/"
...
# testthat::test_dir( "C:/Users/James.Thorson/Desktop/Project_git/geostatistical_delta-GLMM/tests/testthat/" )
